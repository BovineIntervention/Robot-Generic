...
public class JoystickStatusTest {
    ...
    public void writeSingleMessageTest() {
        ...
        statusQueue.write(builder, offset);
        ...
        Optional<JoystickStatus> optStatus = statusReader.readLast();
    ...
    @Test 
    public void writeSingleMessageTest2() {

        var statusQueue = new JoystickStatusQueue2();//MessageQueueManager.getInstance().driveJoystickStatusQueue;
