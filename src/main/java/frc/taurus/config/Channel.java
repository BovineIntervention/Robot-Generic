...
public final class Channel extends Table {
  ...
  public int channelType() { int o = __offset(4); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  ...
  public static void addChannelType(FlatBufferBuilder builder, int channelType) { builder.addInt(0, channelType, 0); }
