...
public final class Configuration extends Table {
  ...
  public frc.taurus.config.Channel channels(int j) { return channels(new frc.taurus.config.Channel(), j); }
  public frc.taurus.config.Channel channels(frc.taurus.config.Channel obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int channelsLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public frc.taurus.config.Channel.Vector channelsVector() { return channelsVector(new frc.taurus.config.Channel.Vector()); }
  public frc.taurus.config.Channel.Vector channelsVector(frc.taurus.config.Channel.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
