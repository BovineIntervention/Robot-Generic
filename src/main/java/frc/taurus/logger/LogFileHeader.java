...
public final class LogFileHeader extends Table {
  ...
  public frc.taurus.config.Configuration configuration() { return configuration(new frc.taurus.config.Configuration()); }
  public frc.taurus.config.Configuration configuration(frc.taurus.config.Configuration obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
